...
const body = [
  ...
  '',
  '1) FORWARD virker naa: vi videresender til https://bli-utleier-redesign.preview.emergentagent.com/api/leads (rental-ops-17 fjernet). To test-leads POSTet -> dere returnerte success:true + data.id (vi lagret platform_id). external_ref ekko-et tilbake. ',
...
const data = {
  ...
  forward_target_preview: 'https://bli-utleier-redesign.preview.emergentagent.com/api/leads',
