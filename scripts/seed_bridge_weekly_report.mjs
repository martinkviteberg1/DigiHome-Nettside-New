...
const body = [
  ...
  '  - Base preview: https://hero-premiere-4.preview.emergentagent.com',
...
const data = {
  ...
  marketing_metrics_endpoint: {
    ...
    base_preview: 'https://hero-premiere-4.preview.emergentagent.com',
  ...
  forward_status: { updated_targets: { preview: 'https://tenant-hub-210.preview.emergentagent.com/api/leads', prod: 'https://app.digihome.no/api/leads' }, pending_confirm: 'endpoint + X-API-Key (Q1-Q4)' },
};
