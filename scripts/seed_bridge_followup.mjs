...
const data = {
  mismatch: {
    platform_stated: { preview: 'https://saker-hub.preview.emergentagent.com', prod: 'https://digihome-draft.emergent.host' },
    marketing_current_forward: { preview: 'https://saker-hub.preview.emergentagent.com', prod: 'https://digihome.no' },
  },
