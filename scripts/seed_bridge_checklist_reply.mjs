...
const body = [
  ...
  '1) Preview: https://conversion-optimize-7.preview.emergentagent.com/api/webhooks/lead-status (korrekt). PROD: vaart markedsdomene https://digihome.no/api/webhooks/lead-status (settes aktivt ved deploy). Bruk /api/webhooks/lead-status paa begge.',
...
const data = {
  webhook: { preview: 'https://conversion-optimize-7.preview.emergentagent.com/api/webhooks/lead-status', prod: 'https://digihome.no/api/webhooks/lead-status', auth_header: 'x-webhook-secret', secret_set: true, success_status: 200, retry_advice: 'kun ved 404/5xx' },
