...
def test_regression():
    ...
    print("9.3: GET https://saker-hub.preview.emergentagent.com/utleiemegler-bergen → 200")
    try:
        r = requests.get("https://saker-hub.preview.emergentagent.com/utleiemegler-bergen", timeout=10)
        if r.status_code == 200:
            html = r.text
    ...
    print("9.4: GET https://saker-hub.preview.emergentagent.com/airbnb-forvaltning-bergen → 200")
    try:
        r = requests.get("https://saker-hub.preview.emergentagent.com/airbnb-forvaltning-bergen", timeout=10)
        if r.status_code == 200:
            html = r.text
    ...
    print("9.5: GET https://saker-hub.preview.emergentagent.com/sitemap.xml → contains both pages")
    try:
        r = requests.get("https://saker-hub.preview.emergentagent.com/sitemap.xml", timeout=10)
        if r.status_code == 200:
            xml = r.text
