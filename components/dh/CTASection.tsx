          ...
          <div className="lg:text-right">
            ...
            <div className="flex flex-wrap items-center gap-4 lg:justify-end">
              <Button onClick={() => router.push('/bli-utleier')}
                className="rounded-full bg-white text-[#0a0a0a] hover:bg-[#f2f0eb] h-[52px] px-8 text-[14px] font-semibold transition-all duration-300 hover:shadow-[0_8px_32px_rgba(255,255,255,0.16)] active:scale-[0.97] gap-2">
            ...
            <div className="flex flex-wrap items-center gap-x-6 gap-y-2 mt-8 lg:justify-end">
              {assurances.map((a) => (
                <span key={a} className="inline-flex items-center gap-1.5 text-[13px] text-white/45">
                  <Check className="w-3.5 h-3.5 text-white/60" strokeWidth={2.5} /> {a}
                </span>
              ))}
            </div>
          </div>
