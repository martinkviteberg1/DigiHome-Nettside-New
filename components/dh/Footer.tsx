...
const cols = [
  ...
  { title: 'Selskap', links: [{ l: 'Bli utleier', h: '/bli-utleier' }, { l: 'Priskalkulator', h: '/priskalkulator' }, { l: 'Bli leietaker', h: '/bli-leietaker' }, { l: 'Ledige boliger', h: '/ledige-boliger' }, { l: 'For bedrifter', h: '/bedrift' }, { l: 'Nyheter', h: '/nyheter' }, { l: 'Kontakt', h: '/kontakt' }] },
