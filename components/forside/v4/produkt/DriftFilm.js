...
export default function DriftFilm({ synlig, spiller = synlig, tema = 'mork', onFerdig, onFremdrift, neste = null, full = false, staaende = false, naken = false }) {
  ...
  return (
    <Ramme synlig={synlig} tema={tema} ov={ov} morkt={morkt} bred={staaende ? false : bred} naken={naken} fase={fase} testid="v4-drift-scene" full={full} desktop={<Desktop {...felles} startet={startet} />} kompakt={<Kompakt {...felles} />} />
  );
}
