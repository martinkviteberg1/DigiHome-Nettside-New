...
export default function OkonomiFilm({ synlig, spiller = synlig, tema = 'mork', onFerdig, onFremdrift, neste = null, full = false, staaende = false, naken = false }) {
  ...
  return (
    <Ramme synlig={synlig} tema={tema} ov={ov} morkt={morkt} bred={staaende ? false : bred} naken={naken} fase={fase} testid="v4-okonomi-scene" full={full} desktop={<Desktop {...felles} startet={startet} />} kompakt={<Kompakt {...felles} />} />
  );
}
