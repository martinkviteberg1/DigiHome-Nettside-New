...
export default function OkonomiFilm({ synlig, spiller = synlig, tema = 'mork', onFerdig, onFremdrift, neste = null }) {
  ...
  return (
    <Ramme synlig={synlig} tema={tema} ov={ov} morkt={morkt} bred={bred} fase={fase} testid="v4-okonomi-scene" desktop={<Desktop {...felles} startet={startet} />} kompakt={<Kompakt {...felles} />} />
  );
}
