...
export default function ConsentBanner() {
  ...
  const isAdmin = (pathname || '').startsWith('/admin') || (pathname || '').startsWith('/investor') || (pathname || '').startsWith('/deck') || (pathname || '').startsWith('/signering') || (pathname || '').startsWith('/tilbud') || (pathname || '').startsWith('/bergen-urban') || (pathname || '').startsWith('/film');
