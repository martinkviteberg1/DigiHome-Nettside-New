...
export default function Partnere() {
  return (
    <section className="bg-[#fdfcfb]" data-testid="nyest-partners">
      <div className="mx-auto flex w-full max-w-[1400px] flex-col gap-7 px-6 py-14 sm:px-10 sm:py-20 lg:flex-row lg:items-center lg:gap-12 lg:px-16">
