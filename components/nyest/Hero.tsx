...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-[#fdfcfb]" data-testid="nyest-hero">
      ...
      <div className="relative mx-auto grid w-full max-w-[1400px] items-center gap-10 px-5 pb-16 pt-[104px] sm:gap-12 sm:px-8 sm:pb-20 sm:pt-[132px] lg:grid-cols-[1.05fr_0.95fr] lg:gap-16 lg:px-16 lg:pb-28 lg:pt-[168px]">
        <div>
