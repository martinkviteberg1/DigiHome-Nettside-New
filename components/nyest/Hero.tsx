...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-[#fdfcfb]" data-testid="nyest-hero">
      ...
      <div className="relative mx-auto grid w-full max-w-[1400px] items-start gap-8 px-5 pb-32 pt-[84px] sm:gap-10 sm:px-8 sm:pb-44 sm:pt-[100px] lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:gap-16 lg:px-16 lg:pb-56 lg:pt-[112px]">
        <div>
