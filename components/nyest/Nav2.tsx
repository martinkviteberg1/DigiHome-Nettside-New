...
// ---------------------------------------------------------------------------
// Full-width navbar for /nyest2 — samme rolige språk som Nav, men uten
// container-begrensning. Passer split-screen layouts der bildet flyter helt
// til viewport-kanten på høyre side.
// ---------------------------------------------------------------------------
...
export default function Nav2() {
  ...
  const startOnboarding = () => {
    try { track('cta_click', { cta: 'nyest2_nav' }); } catch (e) { /* analyse skal aldri blokkere */ }
    setOpen(false);
    router.push('/bli-utleier/start');
  };

  return (
    <header className="fixed left-0 right-0 top-0 z-50" data-testid="nyest2-nav">
      <div
      ...
      >
        {/* Full-width — ingen max-w. Padding følger heroen slik at logoen står
            i flukt med teksten under, og CTA-en flukter med bildekanten. */}
        <div
        ...
        >
          <Link href="/" className="group flex shrink-0 items-center" data-testid="nyest2-nav-logo">
            <img
        ...
        {/* Side-drawer — samme som /nyest. Én sannhet, ett språk. */}
        <div
