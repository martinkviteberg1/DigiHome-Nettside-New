...
- Ikke brukerbekreftet: alt over.
- HERO-VEGG (nåværende): `Veggkort` — editorialt boligkort rett på veggen (ingen mockup): kartbånd tone-i-tone (bergen-kart-m.svg, maskede kanter, lilla nål i sentrum), adressen i display, «5015 Bergen · Leilighet 2», hårlinjerader Byggeår/Areal/Etasje/Leie/Leietaker. To stille endringer: Leietaker «Ledig fra 1. november» → Emma m/ bilde etter slag 1; Leie får «● betalt» etter slag 2. PERSPEKTIV (bruker ba om «enda bedre»): `perspective(1100px) rotateY(21deg) rotateX(2deg)`, origin venstre kant, right 0 %, rader 15.5 px — kortet ligger på veggen som viker mot høyre. Mobil: samme kort nederst over gradient, uten perspektiv. Forkastet: EierApp-mockup (components/forside/v4/EierApp.js ligger igjen ubrukt — kan slettes), «Kvelden er din.», caption i hjørnet.
