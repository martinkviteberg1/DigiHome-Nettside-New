# Voiceover-manus — «Utleie på autopilot» (72 sek, 16:9)
...
| 9 | vo_09.mp3 | 0:49.5 | 6,0 s | «Lurer leietakeren på noe, får de svar på sekunder. Døgnet rundt.» |
| 10 | vo_10.mp3 | 1:04.3 | 2,4 s | «Trygt. Automagisk.» |
| 11 | vo_11.mp3 | 1:08.3 | 3,0 s | «DigiHome. Utleie på autopilot.» |
...
- Linje 10: «Automagisk» uttales som ett naturlig ord — det er filmens signatur.
- Hold replikkene innenfor maks-lengdene, ellers kolliderer de med neste scene.

## Levering
Last opp de 11 MP3-filene her i chatten (eller legg dem i
