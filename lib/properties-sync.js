...
export async function syncPropertiesFromPlatform(db, { target, key, maxPages = 10, pageLimit = 200 } = {}) {
  ...
  let upserted = 0, updated = 0, withDistrict = 0;
  ...
  return { ok: true, synced: rows.length, upserted, updated, withDistrict, staleMarked: staleRes.modifiedCount || 0, partialError: lastError || null };
}
