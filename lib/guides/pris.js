...
export const prisGuides = [
  // ═══════════════════════════════════════════════════════════════════════
  {
    ...
    keyFacts: [
      ...
      '**DigiHome:** selvforvaltning **5 %** per utleieforhold, full forvaltning etter individuelt tilbud — 0 kr oppstart, ingen bindingstid.',
    ],
    sections: [
      {
  ...
  // ═══════════════════════════════════════════════════════════════════════
  {
    ...
    keyFacts: [
      ...
      '**DigiHome:** selvforvaltning **5 %** per utleieforhold, full forvaltning etter individuelt tilbud.',
