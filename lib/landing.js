...
const COMMON_FAQ = [
  {
    ...
    a: 'Vi kontakter deg umiddelbart, og gir deg en konkret vurdering av hva boligen kan tjene. Helt uforpliktende — du bestemmer selv om du vil gå videre.',
  },
  {
    q: 'Hva koster det?',
  ...
  },
  {
    ...
    a: 'Umiddelbart. Du hører fra oss med en gratis, uforpliktende vurdering av hva boligen din kan tjene — som regel i løpet av minutter.',
  },
  {
...
export const COMMON_STEPS = [
  { n: '01', t: 'Gratis vurdering', d: 'Vi analyserer boligen og markedet, og forteller deg nøyaktig hva den kan tjene i Bergen — du får svar umiddelbart.' },
...
export const LANDING = {
  forvaltning: {
    ...
    sub: 'Annonsering, leietakere, husleie og vedlikehold — vi gjør alt, du mottar inntekten. Få en gratis vurdering — svar umiddelbart.',
    bullets: [
  ...
  inntekt: {
    ...
    h1B: 'Hva kan boligen din tjene? Få svar umiddelbart',
    sub: 'Hybridmodellen vår kombinerer langtids- og korttidsutleie med dynamisk prising — uten at du løfter en finger. Se hva din bolig kan tjene — svar umiddelbart.',
    bullets: [
  ...
  '10pluss2': {
    ...
    sub: 'Forutsigbar langtidsinntekt i 10 måneder, og lukrativ korttidsutleie i 2 høysesongmåneder. Det beste fra begge verdener — vurdert gratis, med svar umiddelbart.',
    bullets: [
...
const SAMMENLIGN_FAQ = [
  ...
  },
  {
    ...
    a: 'Ja. Vi hjelper deg gjennom hele byttet — inkludert overgang av leieforhold og kontrakter. Send inn skjemaet, så ser vi på situasjonen din umiddelbart, helt uforpliktende.',
  },
...
LANDING['sammenlign'] = {
  ...
  comparison: {
    ...
    rows: [
      ...
      { label: 'Svartid på henvendelser', us: 'Umiddelbart', them: 'Ofte 1–3 virkedager' },
...
export function normalizeStudioLp(doc) {
  ...
  return {
    ...
    cta: doc.cta || 'Start gratis vurdering',
    urgency: COMMON_URGENCY,
