...
export const LANDING = {
  ...
  'arvet-bolig': {
    ...
    sub: 'Sitter du med en arvet eller tom bolig i Bergen? Vi gjør den utleieklar og forvalter alt for deg. Ingen oppussingsmareritt, ingen leietaker-styr.',
    bullets: [
      'Vi klargjør, styler og annonserer boligen',
      'Full forvaltning — du trenger ikke bo i Bergen',
      'Ingen oppstartskostnader eller bindingstid',
    ],
    image: '/interior-living.webp',
    accent,
    heroStat: { value: '0 kr', label: 'oppstart · vi gjør alt' },
    proofNote: 'En tom bolig koster deg penger hver måned. Utleid gjennom oss gir den trygg inntekt — helt passivt.',
  ...
  'airbnb-langtid': {
    ...
    sub: 'Slipp rengjøring, nøkkeloverlevering og svingende belegg. Med DigiHomes hybridmodell får du høy avkastning uten det daglige styret Airbnb krever.',
    bullets: [
      'Ingen rengjøring, gjestechat eller nøkkelkaos',
    ...
    proofNote: 'Du beholder korttidsoppsiden i høysesong, men slipper alt det daglige arbeidet Airbnb krever.',
