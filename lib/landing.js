...
// Mikro-trygghet under skjemaet. Skal IKKE gjenta «lokalt team i Bergen»,
// som allerede står i samme tillitssone på landingssiden — da leses linjen
// som støy. Denne fjerner i stedet den siste risikoen før innsending.
const COMMON_URGENCY = 'Uforpliktende — du bestemmer om du går videre.';
...
export const LANDING = {
  ...
  // Meta-spesifikk landingsside (opprettet aug. 2026).
  //
  // Bakgrunn: alle Meta-annonser pekte til forsiden. Bare 26 % av Meta-øktene
  // kom videre til en side med skjema, mot 92 % for Google — og Meta konverterte
  // 2,2 % pr. økt mot Googles 4,9 %. Annonsen som brukte 7 796 kr het
  // «Gratis vurdering skjema», men landet på forsiden. Denne siden gir
  // message-match: overskriften lover det samme som annonsen, og skjemaet er
  // det første du ser.
  //
  // Sosiale annonser avbryter — de har ikke søkeintensjon. Derfor er teksten
  // kortere, løftet konkret og terskelen lav (adresse først, ikke telefonnummer).
  'gratis-vurdering': {
    slug: 'gratis-vurdering',
    source: 'lp-gratis-vurdering',
    eyebrow: 'Gratis vurdering · Bergen',
    h1: 'Hva kan boligen din tjene i leie?',
    h1B: 'Gratis vurdering — svar innen 24 timer',
    sub: 'Skriv inn adressen, og vårt lokale team i Bergen regner ut hva boligen din kan gi i leieinntekt. Gratis og uforpliktende.',
    bullets: [
      'Svar innen 24 timer',
      'Helt gratis og uforpliktende',
      'Lokalt team i Bergen — ikke et kundesenter',
    ],
    image: '/interior-openplan-hero.webp',
    accent,
    heroStat: { value: '24 t', label: 'til du har svaret' },
    proofNote: 'Vi ser på boligen, området og dagens leienivå — og gir deg et konkret tall du kan stole på. Prøv kalkulatoren mens du venter.',
    formTitle: 'Få gratis vurdering',
    cta: 'Få gratis vurdering',
    urgency: COMMON_URGENCY,
    metaTitle: 'Gratis vurdering av utleieboligen din i Bergen — DigiHome',
    metaDesc: 'Hva kan boligen din tjene i leie? Få en gratis, uforpliktende vurdering fra DigiHome i Bergen — svar innen 24 timer.',
    faq: COMMON_FAQ,
  },
  '10pluss2': {
    slug: '10pluss2',
