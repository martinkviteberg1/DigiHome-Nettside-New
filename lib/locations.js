...
const IMG = {
  ...
  business: U('https://images.unsplash.com/photo-1612637968894-660373e23b03'),
  suburb: U('https://images.unsplash.com/photo-1567496898669-ee935f5f647a'),
  hillside: U('https://images.unsplash.com/photo-1685610611691-56281a40473d'),
  nordic: U('https://images.unsplash.com/photo-1687187591302-a2b0fb3ac4ed'),
};
...
export const locations = [
  {
    ...
    faq: [
      { q: 'Hvilke områder i Bergen dekker DigiHome?', a: 'Vi forvalter boliger i hele Bergen, inkludert Sentrum, Nordnes, Sandviken, Møhlenpris, Årstad, Åsane, Fana, Fyllingsdalen, Ytrebygda, Laksevåg og Arna.' },
  ...
  },
  {
    ...
    region: 'Bergen',
    image: IMG.nordic,
    tagline: 'Sentrumsnært studentknutepunkt ved Haukeland',
    intro:
      'Årstad er en tett, sentrumsnær bydel som rommer Landås, Kronstad, Minde og Solheimsviken — og huser både Haukeland universitetssjukehus og Høgskulen på Vestlandet (HVL) på Kronstad. Den store konsentrasjonen av studenter, helsepersonell og unge i etableringsfasen gjør Årstad til et av Bergens mest aktive og stabile leiemarkeder året rundt.',
    market: { avgRent: '9 000–19 000 kr/mnd', demand: 'Svært høy', popularTypes: ['Hybel', 'Leilighet', 'Kollektiv'], note: 'Nærhet til Haukeland og HVL gir konstant etterspørsel — særlig hybler og kollektiv ved studiestart i august.' },
    highlights: [
      { title: 'Sykehus og campus', body: 'Haukeland og HVL Kronstad gir en jevn strøm av studenter og helsepersonell som trenger bolig nær jobb og studier.' },
      { title: 'Lav ledighet', body: 'Den sentrale beliggenheten og bybanen gjør at boliger i Årstad sjelden står tomme.' },
      { title: 'Høy yield på hybler', body: 'Hybler og kollektiv gir ofte høyere leieinntekt per kvadratmeter — vi håndterer den hyppigere leietakeromsetningen for deg.' },
    ],
    tenantProfile: 'Studenter ved HVL, helsepersonell ved Haukeland, og unge profesjonelle som vil bo sentrumsnært.',
    faq: [
      { q: 'Hvorfor er Årstad et sterkt leiemarked?', a: 'Årstad huser både Haukeland universitetssjukehus og HVL på Kronstad, noe som gir svært høy og stabil etterspørsel fra studenter og helsepersonell — særlig etter hybler, kollektiv og mindre leiligheter.' },
      { q: 'Lønner det seg å leie ut hybler i Årstad?', a: 'Ja. Hybler og kollektiv nær Haukeland og HVL kan gi høy leieinntekt per kvadratmeter, men krever mer aktiv forvaltning — som DigiHome tar seg av fullt og helt.' },
      { q: 'Hvilke områder dekker Årstad?', a: 'Årstad omfatter blant annet Landås, Kronstad, Minde, Solheimsviken og Brann stadion-området — alle sentrumsnære og godt betjent av bybanen.' },
    ],
    geo: { lat: 60.3712, lng: 5.3478 },
  },
  {
    slug: 'fyllingsdalen',
    name: 'Fyllingsdalen',
    ...
    region: 'Bergen',
    image: IMG.hillside,
    tagline: 'Grønn bydel med ny bybane til sentrum',
    intro:
      'Fyllingsdalen er en stor, grønn boligbydel vest i Bergen, bygget rundt Oasen storsenter og omkranset av populære tur- og rekreasjonsområder. Med den nye bybanelinjen som åpnet i 2023 og knytter bydelen til sentrum på under 20 minutter, har attraktiviteten — og etterspørselen etter leieboliger — fått et tydelig løft.',
    market: { avgRent: '12 000–20 000 kr/mnd', demand: 'Moderat til høy', popularTypes: ['Leilighet', 'Rekkehus'], note: 'Den nye bybanen løfter etterspørselen langs traséen, særlig nær Oasen og bybanestoppene.' },
    highlights: [
      { title: 'Ny bybane til sentrum', body: 'Bybanelinjen fra 2023 gir rask, forutsigbar pendling og har gjort Fyllingsdalen vesentlig mer attraktivt for leietakere.' },
      { title: 'Familievennlig og grønt', body: 'Skoler, barnehager, Oasen storsenter og turområder gjør bydelen ideell for langtidsutleie til familier.' },
      { title: 'Plass for pengene', body: 'Romslige boliger til lavere kvadratmeterpris enn sentrum gir god verdi for både utleier og leietaker.' },
    ],
    tenantProfile: 'Barnefamilier, pendlere og førstegangsleietakere som vil ha plass og natur med rask bybane til sentrum.',
    faq: [
      { q: 'Har bybanen påvirket leiemarkedet i Fyllingsdalen?', a: 'Ja, tydelig. Etter at bybanelinjen til Fyllingsdalen åpnet i 2023, har pendling blitt langt enklere, og etterspørselen etter leieboliger — særlig nær bybanestoppene — har økt.' },
      { q: 'Passer Fyllingsdalen for familier?', a: 'Svært godt. Med skoler, barnehager, Oasen storsenter og store turområder er bydelen attraktiv for barnefamilier som ofte gir lange, stabile leieforhold.' },
      { q: 'Hva er typisk leiepris i Fyllingsdalen?', a: 'Leieprisene ligger typisk mellom 12 000 og 20 000 kr/mnd avhengig av størrelse, standard og nærhet til bybanen.' },
    ],
    geo: { lat: 60.3494, lng: 5.2877 },
  },
  {
    slug: 'ytrebygda',
    name: 'Ytrebygda',
    ...
    region: 'Bergen',
    image: IMG.business,
    tagline: 'Bergens nærings- og flyplassknutepunkt i sør',
    intro:
      'Ytrebygda i sør rommer Kokstad, Sandsli, Blomsterdalen og Bergen lufthavn Flesland — byens viktigste nærings- og teknologiklynge med store arbeidsgivere innen energi, IT og luftfart. Kombinasjonen av tusenvis av arbeidsplasser, Lagunen storsenter og bybanen helt til Flesland gir et stabilt, kjøpesterkt leiemarked drevet av profesjonelle og pendlere. DigiHome har sitt eget hovedkontor på Kokstad og kjenner området ut og inn.',
    market: { avgRent: '13 000–22 000 kr/mnd', demand: 'Høy', popularTypes: ['Leilighet', 'Rekkehus'], note: 'Nærheten til Kokstad/Sandsli-arbeidsplassene og flyplassen gir stabil etterspørsel fra ansatte og pendlere året rundt.' },
    highlights: [
      { title: 'Tusenvis av arbeidsplasser', body: 'Kokstad og Sandsli er Bergens største kontorklynge — ansatte og innleide søker stadig bolig i gang- og pendleravstand.' },
      { title: 'Bybane og flyplass', body: 'Bybanen til Flesland og nærhet til lufthavnen gir både langtids- og korttidspotensial for forretningsreisende.' },
      { title: 'Lokal ekspertise', body: 'Med hovedkontor på Kokstad har DigiHome førstehånds markedskunnskap om hver adresse i Ytrebygda.' },
    ],
    tenantProfile: 'Profesjonelle ved Kokstad- og Sandsli-bedriftene, pendlere, helsepersonell og familier.',
    faq: [
      { q: 'Er Ytrebygda et godt område for utleie?', a: 'Ja. Med Bergens største kontorklynge på Kokstad og Sandsli, flyplassen på Flesland og bybane helt sør, er etterspørselen etter leieboliger stabil og kjøpesterk hele året.' },
      { q: 'Hvem leier vanligvis i Ytrebygda?', a: 'Hovedsakelig profesjonelle som jobber på Kokstad/Sandsli, pendlere, innleid personell og familier som ønsker nærhet til arbeidsplassene og enkel tilkomst via bybanen.' },
      { q: 'Kan korttidsutleie være aktuelt i Ytrebygda?', a: 'Ja. Nærheten til flyplassen og næringslivet gjør at forretningsreisende etterspør korttidsleie, noe DigiHomes hybridmodell kan utnytte sammen med trygg langtidsinntekt.' },
    ],
    geo: { lat: 60.2934, lng: 5.2585 },
  },
  {
    slug: 'arna',
    name: 'Arna',
    ...
    region: 'Bergen',
    image: IMG.suburb,
    tagline: 'Voksende dalbydel med tog til sentrum på åtte minutter',
    intro:
      'Arna øst for byfjellene er Bergens grønne dalbydel, med Arna stasjon som gir tog til sentrum på bare åtte minutter gjennom Ulriken-tunnelen. Nytt dobbeltspor, økt togfrekvens og flere boligprosjekter har gjort Arna til et attraktivt og prisgunstig alternativ for dem som vil bo landlig med rask tilkomst til byen.',
    market: { avgRent: '11 000–18 000 kr/mnd', demand: 'Moderat', popularTypes: ['Enebolig', 'Rekkehus', 'Leilighet'], note: 'Det nye dobbeltsporet og hyppigere tog løfter Arna som pendlerbydel — god direkteavkastning på rimeligere boliger.' },
    highlights: [
      { title: 'Tog på åtte minutter', body: 'Dobbeltsporet gjennom Ulriken gir rask, forutsigbar pendling til sentrum og gjør Arna stadig mer attraktivt for leietakere.' },
      { title: 'Prisgunstig vekst', body: 'Lavere inngangspriser kombinert med nye boligprosjekter gir god yield for utleiere som er tidlig ute.' },
      { title: 'Landlig familieliv', body: 'Natur, skoler og rolige omgivelser gir lange, stabile leieforhold med familier.' },
    ],
    tenantProfile: 'Pendlere, barnefamilier og prisbevisste leietakere som ønsker landlige omgivelser nær byen.',
    faq: [
      { q: 'Hvor raskt kommer man til sentrum fra Arna?', a: 'Toget bruker bare rundt åtte minutter fra Arna stasjon til Bergen sentrum gjennom Ulriken-tunnelen, og med det nye dobbeltsporet går avgangene hyppigere enn før.' },
      { q: 'Er Arna et godt sted å leie ut?', a: 'Arna er et prisgunstig vekstområde der bedre togtilbud og nye boligprosjekter løfter etterspørselen — det kan gi god direkteavkastning for utleiere som er tidlig ute.' },
      { q: 'Hvilke boligtyper er mest etterspurt i Arna?', a: 'Eneboliger, rekkehus og leiligheter med flere soverom er mest etterspurt, særlig blant familier og pendlere som ønsker plass og natur.' },
    ],
    geo: { lat: 60.4214, lng: 5.4647 },
  },
];
...
export function relatedLocations(slug, n = 3) {
  const bydeler = locations.filter((l) => l.type === 'bydel' && l.slug !== slug);
  if (bydeler.length <= n) return bydeler;
  // Roter utvalget basert på gjeldende slug, slik at hver side lenker til ulike
  // områder. Dette gir et jevnere, mer crawlbart internt lenkegraf (bedre SEO).
  const start = (slug.charCodeAt(0) + slug.length) % bydeler.length;
  const out = [];
  for (let i = 0; i < n; i++) out.push(bydeler[(start + i) % bydeler.length]);
  return out;
}
