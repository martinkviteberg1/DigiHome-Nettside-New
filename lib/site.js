...
export const steps = [
  { no: '01', title: 'Dynamisk utleie', body: 'Korttids- og langtidsutleie i én hybridmodell. Tilpasses automatisk etter sesong og etterspørsel.' },
  { no: '02', title: 'Intelligent prising', body: 'Prisalgoritmer overvåker markedet døgnet rundt og justerer for optimal avkastning.' },
  { no: '03', title: 'Helhetlig drift', body: 'Nøkler, rengjøring, gjestekommunikasjon og vedlikehold — alt håndtert av vårt team.' },
  { no: '04', title: 'Leietakerportal', body: 'Betaling, kommunikasjon og henvendelser samlet på én plattform.' },
];
