...
export const site = {
  name: 'DigiHome',
  legalName: 'Digihome AS',
  orgNr: '835 595 242',
  url: 'https://digihome.no',
  loginUrl: 'https://app.digihome.no/logg-inn',
  ...
  brregUrl: 'https://data.brreg.no/enhetsregisteret/oppslag/enheter/835595242',
  social: {
  ...
  priceRange: '$$',
  foundingYear: '2023',
  // Kokstad, Bergen — omtrentlige koordinater for LocalBusiness-schema
  geo: { lat: 60.2935, lng: 5.258 },
};
...
export const stats = [
  { value: '150+', label: 'Boliger' },
  { value: '24 t', label: 'Svartid' },
  { value: '+30%', label: 'Potensial' },
];

export const statStrip = [
  { value: '+30%', label: 'Inntektspotensial', sub: 'scenarioestimat for egnede boliger — se metode' },
  { value: '150+', label: 'Boliger', sub: 'akkumulert forvaltet eller håndtert' },
  { value: '24 t', label: 'Svartid', sub: 'på nye henvendelser' },
];
...
export const neighborhoods = [
  ...
  'Laksevåg', 'Fana', 'Åsane', 'Fyllingsdalen', 'Ytrebygda', 'Arna',
  'Landås', 'Minde', 'Kronstad', 'Solheimsviken', 'Damsgård', 'Kokstad', 'Sandsli',
];

// FAQ skrevet for sitering i AI-søk (ChatGPT, Perplexity, Google AI Overviews)
// og for FAQPage structured data. Klare, faktabaserte svar.
export const faq = [
  {
    q: 'Hva er DigiHome?',
    a: 'DigiHome er en AI-drevet eiendomsforvalter i Bergen som hjelper boligeiere med å maksimere leieinntekten gjennom en hybrid av korttids- og langtidsutleie. Vi håndterer alt fra annonsering og prising til visninger, kontrakter, husleie og leietakeroppfølging.',
  },
  {
    q: 'Hvordan fungerer 10+2-modellen?',
    a: '10+2 kombinerer langtidsutleie med en avgrenset periode korttidsutleie. Modellen er bare aktuell når eierform, vedtekter og lovlige døgnsgrenser tillater det. For enkelte egnede boliger kan scenarioet vise opptil 30 % høyere inntekt, men dette er et estimat — ikke en garanti.',
  },
  {
    q: 'Hvor mye mer kan jeg tjene med DigiHome?',
    a: 'For enkelte egnede boliger kan DigiHomes scenarioestimat vise opptil 30 % høyere leieinntekt enn et relevant langtidsestimat. Resultatet varierer med bolig, område, sesong, pris, kostnader og lovlig utleiemodell, og er ikke en garanti. Se metode- og forbeholdssiden vår.',
  },
  {
    q: 'Er det bindingstid eller oppstartskostnader?',
    a: 'Nei. DigiHome har ingen oppstartskostnader og ingen bindingstid. Du betaler kun når eiendommen din faktisk genererer leieinntekt.',
  },
  {
    q: 'Hvilke områder dekker DigiHome?',
    a: 'DigiHome forvalter i dag eiendommer i hele Bergen, inkludert Nordnes, Sandviken, Møhlenpris, Sentrum, Åsane, Fana og Laksevåg. Vi utvider gradvis til flere byer i Norge.',
  },
  {
    q: 'Hva er inkludert i forvaltningen?',
    a: 'Full forvaltning inkluderer profesjonell annonsering, fotografering og styling, dynamisk prising, leietakerscreening, digitale kontrakter, innkreving av husleie, renhold, vedlikehold via vårt partnernettverk og løpende leietakeroppfølging — alt samlet i én digital plattform.',
  },
];
