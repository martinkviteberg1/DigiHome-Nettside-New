...
export function beregnSikretSerie(rows = [], year, antallMnd = 12) {
  ...
  for (const r of rows) {
    ...
    const honorar = r.fee_amount > 0 ? r.fee_amount : Math.round((r.monthly_rent || 0) * snittSats);
