...
// Summerer annonserader. VIKTIG: rader merket statsScope:'lifetime' er
// LIVSTIDSTALL for pausede annonser uten levering i perioden (brukes bevisst i
// annonsetabellen for å vise historikk). De skal ALDRI inn i en periodetotal —
// ellers blåses annonseforbruk/CPL/CAC/ROAS opp.
export function aggregate(ads = []) {
  return ads.filter((a) => a?.statsScope !== 'lifetime').reduce((t, a) => ({
