...
export async function buildPaidFunnel(db, { days = 30, adStats = {} } = {}) {
  ...
  return {
    ...
    metaNote: 'Kun trafikk med eksplisitt betalt-merking (utm_medium=cpc/paid) telles som annonsetrafikk — organiske Facebook/Instagram-klikk (kun fbclid) havner under «Organisk / annet».',
  };
}
