...
export const EDITORIAL_FIELDS = [
  ...
  { key: 'rentalScope', label: 'Utleieenhet', kind: 'enum', options: RENTAL_SCOPES, target: 'rentalScope', hint: 'Ved «begge» må interessenten velge hele enheten eller rom når hun melder interesse. Ved kun rom vises ikke plattformens helbolig-leie — sett en prisantydning per rom i Månedsleie.' },
