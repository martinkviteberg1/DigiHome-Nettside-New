...
export const guides = [
  {
    ...
    metaTitle: 'Utleiemegler pris 2026: 8–12 % og gebyrer',
...

  {
    ...
    author: { name: 'Sarah Sleeman', role: 'Daglig leder og eiendomsmegler', url: '/om-oss' },
    reviewer: { type: 'Organization', name: 'DigiHome fagredaksjon', role: 'Utleie- og kildesjekk', url: '/metode' },
    sources: [
      { label: 'Lovdata: husleieloven', url: 'https://lovdata.no/lov/1999-03-26-17' },
      { label: 'SSB: Leiemarkedsundersøkelsen', url: 'https://www.ssb.no/bygg-bolig-og-eiendom/bolig-og-boforhold/statistikk/leiemarkedsundersokelsen' },
      { label: 'Husleietvistutvalget: veiledning om utleie', url: 'https://www.htu.no/' },
    ],
...

  {
    ...
    answer: 'Depositum ved boligutleie kan maksimalt utgjøre seks måneders husleie og skal stå på en særskilt depositumskonto i leietakers navn. Utleier betaler kostnaden ved å opprette kontoen. Pengene kan ikke disponeres ensidig. Bankens forenklede prosedyre for å dekke skyldig husleie forutsetter at husleielovens konkrete vilkår er oppfylt, inkludert relevante kontoforhold. Depositum skal aldri betales til utleiers private konto.',
    sections: [
      {
      ...
      },
      {
        ...
        list: [
          ...
          'Bankforhold og utbetaling: Depositumskonto og husleiekonto kan som hovedregel stå i ulike banker. Bankvalget kan likevel påvirke muligheten for forenklet utbetaling ved skyldig husleie; kontroller de konkrete vilkårene med banken og husleieloven',
...

  {
    ...
    description: 'Når er leieinntekt skattefri? Se 22 % skatt, fradrag, korttidsutleie og hvordan Skatteetaten vurderer om utleien er næringsvirksomhet.',
    category: 'Skatt',
    readMinutes: 7,
    updated: '2026-07-28',
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'Tradisjonelle utleiemeglere oppgir ofte etableringshonorar og et løpende prosent- eller månedsbasert honorar. Selvforvaltning er vanligvis rimeligere fordi boligeieren gjør mer selv. Full forvaltning koster mer, men bør vurderes mot spart tid, raskere håndtering og redusert operativ risiko.',
          'DigiHome oppgir 5 % per utleieforhold for selvforvaltning. Full forvaltning prises individuelt etter bolig, tjenesteomfang og marked. Be alltid om et skriftlig tilbud som viser hele førsteårskostnaden.',
        ],
      },
      {
        ...
        list: [
          ...
          'Du kjenner husleieloven, depositumsreglene og skattereglene — eller bruker gode systemer',
    ...
    author: { name: 'Sarah Sleeman', role: 'Daglig leder og eiendomsmegler', url: '/om-oss' },
    reviewer: { type: 'Organization', name: 'DigiHome fagredaksjon', role: 'Pris- og utleiekildesjekk', url: '/metode' },
    sources: [
      { label: 'Lovdata: husleieloven', url: 'https://lovdata.no/lov/1999-03-26-17' },
      { label: 'SSB: Leiemarkedsundersøkelsen', url: 'https://www.ssb.no/bygg-bolig-og-eiendom/bolig-og-boforhold/statistikk/leiemarkedsundersokelsen' },
      { label: 'DigiHome: metode og forbehold', url: '/metode' },
    ...
    faqs: [
      { q: 'Er selvforvaltning alltid billigst?', a: 'Tjenesteprisen er vanligvis lavere, men verdien av egen tidsbruk, tomgang, feilprising og håndtering av konflikter må tas med i regnestykket.' },
      ...
      { q: 'Kan jeg starte selv og bytte til full forvaltning senere?', a: 'Ja, dersom avtalen og systemene tillater det. Avklar overgang, data, dokumenter og eventuelle oppsigelsesfrister før du velger leverandør.' },
